...
/**
 * Realistic rows for `npm run seed` / `npm run seed:mock` (MongoDB only — not used by the React app).
 */
export const MOCK_ARTICLE_DEFINITIONS: MockArticleDefinition[] = [
  ...
  {
    title: 'Hyderabad — guest lecture on system design',
  ...
  {
    title: 'Pune — library digital resources',
  ...
  {
    title: 'Industry visit — manufacturing unit',
  ...
  {
    title: 'Chennai — Wi-Fi maintenance window',
